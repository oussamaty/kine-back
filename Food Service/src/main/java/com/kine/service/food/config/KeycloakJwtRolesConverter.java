...
public class KeycloakJwtRolesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
     ...
     */
    public static final String PREFIX_REALM_ROLE = "ROLE_REALM";
    /**
        ...
        if (realmAccess != null && !realmAccess.isEmpty()) {
            ...
            if (roles != null && !roles.isEmpty()) {
                ...
                Collection<GrantedAuthority> realmRoles = roles.stream()
                        ...
                        .map(role -> new SimpleGrantedAuthority(PREFIX_REALM_ROLE + role.toUpperCase(Locale.ROOT)))
        ...
        if (resourceAccess != null && !resourceAccess.isEmpty()) {
            ...
            resourceAccess.forEach((resource, resourceClaims) -> {
                ...
                resourceClaims.get(CLAIM_ROLES).forEach(
                        ...
                        role -> grantedAuthorities.add(new SimpleGrantedAuthority(PREFIX_RESOURCE_ROLE + role.toUpperCase(Locale.ROOT)))
                );
            });
        }
